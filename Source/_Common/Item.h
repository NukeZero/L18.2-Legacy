...
public:
	...
	DWORD GetLook() const noexcept { return m_dwLookId; }
	bool IsChangedLook() const noexcept { return m_dwLookId != NULL_ID && m_dwLookId != NULL; }
	ItemProp*	GetNewID()	{	return prj.GetItemProp( m_dwLookId );	}
#endif
public:
