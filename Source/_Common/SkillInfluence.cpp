...
#endif // __PROP_0827
#if __VER >= 18
				m_pMover->ResetDestParam( pItemProp->dwDestParam4, pItemProp->nAdjParamVal4, TRUE );
				m_pMover->ResetDestParam( pItemProp->dwDestParam5, pItemProp->nAdjParamVal5, TRUE );
				m_pMover->ResetDestParam( pItemProp->dwDestParam6, pItemProp->nAdjParamVal6, TRUE );
#endif
